...
class Course(models.Model):
    ...
    need_konw = models.CharField( max_length=300, verbose_name='课程描述',default='')
    teacher_tell = models.CharField( max_length=300, verbose_name='老师提醒',default='')
    ...
    def get_zj_nums(self):#获取章节数
        return self.lesson_set.all().count()

    def get_learn_users(self):#获取学习某门课程的学习人数
    ...
    def __unicode__(self):
        return self.name  #from AbstractUser
...
class CourseResource(models.Model):
    ...
    download = models.ImageField(upload_to="course/resource/%Y/%m", verbose_name=u"资源文件", max_length=100)
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
